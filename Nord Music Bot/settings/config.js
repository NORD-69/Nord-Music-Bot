module.exports = {
  TOKEN: process.env.TOKEN || "TMTAxOTQ5OTk4OTEyNDI3MjE3MA.Gpbydt.Al3orWdZI7evlZLVKyjZt3PVWdPMbireEyI-hw",
  PREFIX: process.env.PREFIX || ";",
  embed: {
    color: process.env.color || "#220f80",
    wrongcolor: process.env.wrongcolor || "#8a0808",
    footertext: "Coded By Nord",
  },
  emoji: {
    ERROR: "❌",
    SUCCESS: "✅",
  ...
  // others
  mongodb: process.env.MONGO_URL || "mongodb+srv://anitrout69:<quadcopter4@>@norddb.hqnujes.mongodb.net/",
  filters: {
  ...
  links: {
    inviteURL:
      ...
      `https://discord.com/api/oauth2/authorize?client_id=1019499989124272170&permissions=8&scope=bot%20applications.commands`,
    DiscordServer: process.env.DiscordServer || `https://discord.gg/Rm2U4krq8R`,
    VoteURL: process.env.VoteURL || `https://discord.gg/Rm2U4krq8R`,
    Website: `https://filmfix.org`,
  },
  options: {
    embedFooter: true,
    nowplayingMsg: true,
  ...
  slash: {
    global: true,
    guildID: process.env.GUILD_ID || "863363929790742539", // for slash command
  },
};
